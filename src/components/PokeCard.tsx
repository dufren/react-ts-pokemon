...
const PokeCard = ({ poke }: PropsType) => {
  ...
  return (
    <Link
      ...
      className="flex flex-col items-center justify-center gap-5 rounded-lg border border-gray-400 bg-gray-200 transition duration-300 hover:scale-105"
    >
      <img
